...
public class CollectNames {
	public static void main( String[] args ) throws Exception
	{
		...
		File topDir = new File("/media/wind/Data/郝阳-上市公司数据");
		String outputFilePath ="/media/wind/Data/郝阳-上市公司数据/2014/validResult/features_list";
		String templateSource = "/media/wind/Data/郝阳-上市公司数据/2014/validResult/features_list_template";
		//CountFeatures(topDir, outputFilePath); // extract words in features, then clean them by hand
		System.out.println(countLegal(topDir, templateSource)); // the rate of valid feature files extracted
		deleteIllegal(topDir, templateSource);
	}
	...
	static public double countLegal(File topDir, String templateSource)
	{
		...
		System.out.println("Total feature files: " + files.size());


		List<String> words = new ArrayList<String>();
		List<String> templateWords = CollectNames.getLinesFromFile(new File(templateSource));

		System.out.println("Total template words: " + templateWords.size());
		...
		for (File file: files)
		{
			...
			List<String> features = getLinesFromFile(file);
			boolean allLegal = isAllLegal(templateWords, features);
	...
	static public void deleteIllegal(File topDir, String templateSource)
	{
		List<File> files = new ArrayList<File>();
	...
	public static boolean isAllLegal(List<String> templateWords, List<String> features) {
	...
	public static boolean isValid(String str)
	{
		...
		if (result == false)
		{
			System.out.println("Invalid feature file.");
		}
